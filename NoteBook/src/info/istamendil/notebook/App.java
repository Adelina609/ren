...
import info.istamendil.notebook.myClasses.MemoryDb;
...
public class App extends Application{
    ...
    public App(String[] args) throws UserInteractorException {
        super(args);
    }

    @Override
    public void init() throws UserInteractorException {
        this.terminal = new ConsolUserInteractor();
        this.db = new MemoryDb(5);
    }
